...
def vectorize_sequence(sequences, dimension=20000):
...
def train():
    (train_data, train_lables), (test_data, test_lables) = imdb.load_data(num_words=20000)
    ...
    model.add(layers.Dense(16, kernel_regularizer=regularizers.l2(0.001), activation='relu', input_shape=(20000,)))
